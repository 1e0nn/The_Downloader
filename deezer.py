...
def init_deezer_session(arl, proxy_server: str, quality: str) -> None:
...
def parse_deezer_playlist(playlist_id):
    ...
    if number_songs != json_data['SONGS']['count']:
        print(f"Warning ! Missing songs from API: {number_songs - json_data['SONGS']['count']}")

    #print(len(json_data['SONGS']['data']))
